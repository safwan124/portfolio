...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/syed-safwan-2a5bb518a/',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/safwan124',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:syed.safwan@example.com',
      icon: (
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">syed.safwan@example.com</p>
                  </div>
                </div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 bg-gray-800 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300"
                    title={social.name}
                  >
                    {social.icon}
                  </motion.a>
